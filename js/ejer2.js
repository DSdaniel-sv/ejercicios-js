...
function MenuEjercicios(nro_ejercicio){
    switch(nro_ejercicio){
        ...
        case 13:
            const calificaciones = parseInt(prompt("Ingresar calificación: "));
            alert(ejer13_CalificacionesAlumnos(calificaciones));
            
           
            alert(ejer13_CalificacionesAlumnos(calificacion_aprobatoria, nota_1, nota_2, nota_3, aprobadas, desaprobadas))
        case 15:
...
function ejer13_CalificacionesAlumnos(calificaciones){
    if(isNaN(calificaciones)){
        return "Porfavor poner valores";
    } else {
        if(calificaciones >= 0 && calificaciones < 14){
            return "Usted esta desaprobado"
        } else if(calificaciones >= 14 && calificaciones >= 20 ){
            return "Usted esta probado"
